...
export const s = {
  ...
  // Fixed-position so the card escapes the list container's overflow clipping;
  // anchored to the cell's viewport rect on hover.
  ...
  findingsPreviewConf: { color: "var(--text-muted)" } satisfies CSSProperties,
  findingsPreviewRationale: {
    marginTop: 4,
    fontSize: 12,
    lineHeight: 1.45,
    color: "var(--text-secondary)",
